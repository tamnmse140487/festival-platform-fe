            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredGroups.map(group => (
                <GroupCard
                  ...
                  hasManagePermission={hasRole([ROLE_NAME.STUDENT])}
                />
              ))}
            </div>
          )}
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <div className="flex items-center space-x-2 mt-1">
            ...
            <span className={`px-2 py-1 text-xs rounded ${group.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
              }`}>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span className={`px-2 py-1 text-xs font-medium rounded ${group.booth.status === 'approved' ? 'bg-green-100 text-green-800' :
...
export default MyStudentGroupPage;